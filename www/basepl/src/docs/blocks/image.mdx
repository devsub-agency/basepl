...
Here is the result in the admin panel and the pre-configured image block itself. You can change it to your needs in the `blocks/BaseplImage/config.ts`file.

<BlockPreview name="BaseplImage" imagePath="image-preview-dark.png" />
